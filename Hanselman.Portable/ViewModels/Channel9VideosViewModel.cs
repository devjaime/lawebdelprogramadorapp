    ...
    public class Channel9VideosViewModel : BaseViewModel
    {
        ...
        private async Task ExecuteLoadItemsCommand()
        {
            ...
            try
            {
                ...
                var feed = "https://www.youtube.com/channel/UCQsrs_h91Q-baLx-n_rcdNg";
            ...
            if (error)
            {
                ...
                await page.DisplayAlert("Error", "Canal de videos no disponible.", "OK");
            }
        }
            ...
            return await Task.Run(() =>
            {
                ...
                foreach (var item in xdoc.Descendants("item"))
                {
                    try
                    {
                        ...
                        {
                            var keyword = "jaimehernandez".ToLowerInvariant();
